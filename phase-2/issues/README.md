...
| [P2-05](P2-05-api-conventions.md) | API Conventions (generic patterns) | BE | 🟡 Open | P2-04, business-rules | `discovery/api-conventions.md` |
| [P2-06](P2-06-api-spec.md) | API Spec v1 (OpenAPI/Swagger) | BE | 🟡 Open | P2-04, P2-05, user_flow | `openapi.yaml` trong `pbl6-backend` |
| [P2-07](P2-07-diagrams.md) | Process Diagrams (use case, sequence, activity) | PM + BE | 🟡 Open | P2-01, P2-04, P2-05, P2-06 | `discovery/diagrams/` |
| [P2-08](P2-08-design-freeze.md) | Design Review → Freeze | All | 🟡 Open | P2-01–P2-07 | Design frozen ✓ |
...
P2-01 (Feature→Platform Map)
  ...
  ├── P2-04 (ERD)
  │     │
  │     └── P2-05 (API Conventions) ──── P2-06 (API Spec)
  │
  └── P2-07 (Diagrams)
        │
    P2-08 (Freeze)
...
| Role | Tasks |
|------|-------|
| **PM** | P2-01 (draft), P2-07 (diagrams), P2-08 (review) |
| **FE** | P2-01 (verify), P2-03 (wireframe web) |
| **Mobile** | P2-01 (verify), P2-03 (wireframe mobile) |
| **BE** | P2-04 (ERD), P2-05 (API conventions), P2-06 (API spec) |
| **AI** | — (Phase 3) |
...
4. P2-05: API conventions (response, pagination, error, auth, naming)
5. P2-06: API spec trên conventions + ERD
6. P2-07: Process diagrams
7. P2-08: Review → freeze
